...
func (sq *SecretQuery) QueryTeam() *TeamQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, secret.TeamTable, secret.TeamColumn),
		)
...
func (sq *SecretQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SecretQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (sq *SecretQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SecretQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (sq *SecretQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (sq *SecretQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SecretQuery) WithTeam(opts ...func(*TeamQuery)) *SecretQuery {
	query := (&TeamClient{config: sq.config}).Query()
...
func (sq *SecretQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Secret, error) {
	...
	if query := sq.withTeam; query != nil {
		if err := sq.loadTeam(ctx, query, nodes, nil,
			func(n *Secret, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *SecretQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*Secret, init func(*Secret), assign func(*Secret, *Team)) error {

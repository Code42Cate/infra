...
func CreateSecret(ctx context.Context, db *db.DB, secretVault *vault.Client, teamID uuid.UUID, value string, label string, description string, allowlist []string) (*models.Secret, string, error) {
